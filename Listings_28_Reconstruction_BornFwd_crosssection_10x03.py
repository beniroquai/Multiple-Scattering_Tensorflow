...
''' Define Fwd operator'''
tf_fwd = muscat.computeconvolution(muscat.TF_ATFm, myfac=1e-1)
...
#tf_lossop_aberr = tf_optimizer.minimize(tf_loss, var_list = [muscat.TF_zernikefactors])muscat.TF_zernikefactors
