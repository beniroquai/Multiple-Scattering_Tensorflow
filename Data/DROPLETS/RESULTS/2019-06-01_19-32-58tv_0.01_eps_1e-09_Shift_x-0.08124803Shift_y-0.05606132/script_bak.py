...
for iterx in range(iter_last,Niter):
    ...
    if is_estimatepsf:
        zern_error = sess.run([TF_zernloss], feed_dict={muscat.tf_meas:np_meas, muscat.tf_learningrate:my_learningrate, muscat.tf_lambda_tv:lambda_tv, muscat.tf_eps:myepstvval})
        print(zern_error)
