...
lambda_tv = ((1e-3, 1e-2, 1e-4)) # lambda for Total variation - 1e-1
eps_tv =((1e-10, 1e-12, 1e-8)) # - 1e-1 # smaller == more blocky
...
muscat.computesys(obj, is_padding=is_padding, dropout_prob=1, mysubsamplingIC=mysubsamplingIC)
