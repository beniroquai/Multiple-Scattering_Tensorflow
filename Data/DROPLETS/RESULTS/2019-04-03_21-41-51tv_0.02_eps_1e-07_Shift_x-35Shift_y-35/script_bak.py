...
NreduceLR = 400 # when should we reduce the Learningrate? 

# TV-Regularizer 
mylambdatv = 2e-2#1e1 ##, 1e-2, 1e-2, 1e-3)) # lambda for Total variation - 1e-1
myepstvval = 1e-7##, 1e-12, 1e-8, 1e-6)) # - 1e-1 # smaller == more blocky
