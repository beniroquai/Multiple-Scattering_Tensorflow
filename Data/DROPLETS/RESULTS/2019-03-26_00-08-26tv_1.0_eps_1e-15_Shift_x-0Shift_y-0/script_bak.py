...
if is_recomputemodel:
    ...
    tf_lossop_aberr = tf_optimizer.minimize(tf_loss, var_list = [muscat.TF_shiftIcX, muscat.TF_shiftIcY])
    tf_lossop = tf_optimizer.minimize(tf_loss) #muscat.TF_zernikefactors
