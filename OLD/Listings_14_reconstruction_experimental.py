...
tf_tvloss = tf_lambda_tv*reg.tf_total_variation_regularization(muscat.TF_obj_phase, BetaVals = [muscat.dx,muscat.dy,muscat.dz], epsR=epsTV)  #Alernatively tf_total_variation_regularization # total_variation
