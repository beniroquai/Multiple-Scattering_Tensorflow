...
if(0):
    ...
    obj_meas_filename = './Data/cells/Beads_40x_100a_100-250.tif_allAmp.mat'
    matlab_par_filename = './Data/cells/Beads_40x_100a_100-250.tif_myParameter.mat'
    matlab_par_name = 'myParameter' 
    matlab_val_name = 'allAmpSimu' 
    mybackgroundval = -.95j  
elif(0):
    # data files for parameters and measuremets 
    obj_meas_filename = './Data/cells/cross_section_10x0.3_hologram_full.tif_allAmp.mat'
    matlab_par_filename = './Data/cells/cross_section_10x0.3_hologram_full.tif_myParameter.mat'
    matlab_par_name = 'myParameter' 
    matlab_val_name = 'allAmpSimu'
    mybackgroundval = -1j
    ...
    # data files for parameters and measuremets 
    obj_meas_filename = './Data/cells/cross_section_10x0.3_hologram_full.tiffull_allAmp.mat'
    matlab_par_filename = './Data/cells/cross_section_10x0.3_hologram_full.tif_full_myParameter.mat'
    matlab_par_name = 'myParameter' 
    matlab_val_name = 'allAmpSimu'
    mybackgroundval = -1j
    ...
    # data files for parameters and measuremets 
    obj_meas_filename = './Data/cells/SiO2_5um_20x0.5.cdf.tif_allAmp.mat'
    matlab_par_filename = './Data/cells/SiO2_5um_20x0.5.cdf.tif_myParameter.mat'
    matlab_par_name = 'myParameter' 
    matlab_val_name = 'allAmpSimu'
    mybackgroundval = -1j
    dn = 1.52-1.33
    ...
    '''HELA CELL GOOD! '''
    # data files for parameters and measuremets 
    obj_meas_filename = './Data/cells/Cell_20x_100a_120-270.tif_allAmp.mat'
    matlab_par_filename = './Data/cells/Cell_20x_100a_120-270.tifmyParameter.mat'
    matlab_par_name = 'myParameter' 
    matlab_val_name = 'allAmpSimu'   
    mybackgroundval = -.9
    dn = 0.05
    shiftIcY = -.05#-22#0*35 # has influence on the YZ-Plot - negative values shifts the input wave (coming from 0..end) to the left
    shiftIcX = -.05#-22.#*35 # has influence on the XZ-Plot - negative values shifts the input wave (coming from 0..end) to the left
    NAc = .32
    ...
    '''CHeek CELL GOOD! '''
    # data files for parameters and measuremets 
    obj_meas_filename = './Data/cells/Cheek_20x_3.tif_allAmp.mat'
    matlab_par_filename = './Data/cells/Cheek_20x_3.tifmyParameter.mat'
    matlab_par_name = 'myParameter' 
    matlab_val_name = 'allAmpSimu'   
    mybackgroundval = -1.
    dn = 0.06
    ...
    '''Spheres GOOD! '''
    # data files for parameters and measuremets 
    obj_meas_filename = './Data/cells/uspheres_40x_1.tif_allAmp.mat'
    matlab_par_filename = './Data/cells/uspheres_40x_1.tifmyParameter.mat'
   ...
   # zernikemask[0]=0
    ...
    '''Spheres OLD! '''
    # data files for parameters and measuremets 
    obj_meas_filename = './Data/cells/Beads_40x_100a_110_220.tif_allAmp.mat'
    matlab_par_filename = './Data/cells/Beads_40x_100a_110_220.tifmyParameter.mat'
   ...
   # zernikemask[0]=0
    ...
    '''Spheres GOOD! '''
    # data files for parameters and measuremets 
    obj_meas_filename = './Data/cells/cheek_40x_1.tif_allAmp.mat'
    matlab_par_filename = './Data/cells/cheek_40x_1.tifmyParameter.mat'
    ...
    # data files for parameters and measuremets 
    obj_meas_filename = './Data/cells/HeLa_JL1_a_zstack_dz0-3um_60planes.tif_allAmp.mat'
    matlab_par_filename = './Data/cells/HeLa_JL1_a_zstack_dz0-3um_60planes.tifmyParameter.mat'
    matlab_par_name = 'myParameter' 
    matlab_val_name = 'allAmpSimu'   
    mybackgroundval = -0.
    mybackgroundval = 0.
